...
int main( void )
{
	...
	string filename_write = "mobility_1534394649_cartesian.txt";
	...
	if (rstr.is_open())
	{
		...
		while(!rstr.eof())
		{
			...
			double x = earth_radius * cos(latitude) * cos(longitude) - 3937900;
			double y = earth_radius * cos(latitude) * sin(longitude) - 512200;
